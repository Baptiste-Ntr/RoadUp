                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Brève description de votre profil. Les URLs sont cliquables.
                    </p>
                  </div>
                  ...
                  <div className="flex items-start justify-between p-4 rounded-lg border bg-muted/30">
                    <div>
                      <div className="flex items-center gap-2">
                        <h3 className="font-semibold text-primary">Growth Plan</h3>
                  ...
                  <div className="flex items-center justify-between p-4 rounded-lg border">
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        ...
                        <span className="text-xs text-muted-foreground">Expire 12/2025</span>
                      </div>
                    </div>
                ...
                <CardContent className="space-y-6">
                  <div className="flex items-center justify-between py-3">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Recevez des emails sur les nouvelles features et améliorations.
                      </p>
                    </div>
                    <Switch
                  ...
                  <div className="flex items-center justify-between py-3">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Soyez notifié des connexions suspectes et problèmes de sécurité.
                      </p>
                    </div>
                    <Switch
                  ...
                  <div className="flex items-center justify-between py-3">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Recevez des conseils, tutoriels et offres marketing.
                      </p>
                    </div>
                    <Switch
