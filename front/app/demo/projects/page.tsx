  ...
  return (
    <div className="space-y-6">
              ...
              return (
                ...
                >
                  <td className="py-4 px-4">
                    <Link
                      href={`/demo/roadmap?project=${project.slug}`}
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        <DropdownMenuItem asChild>
                          <Link href={`/demo/roadmap?project=${project.slug}`}>
      ...
      <ConfirmDialog
        ...
        description={`Êtes-vous sûr de vouloir supprimer "${projectToDeleteData?.name}" ? Cette action est irréversible.`}
