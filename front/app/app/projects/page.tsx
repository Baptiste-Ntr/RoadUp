...
// Mock data
const mockProjects: (Project & { role: CollaboratorRole | "owner"; members: { name: string; avatar?: string }[] })[] = [
  {
    id: "1",
    name: "Q3 Mobile App Launch",
    slug: "q3-mobile-app-launch",
  ...
  },
  {
    ...
    role: "viewer",
    members: [{ name: "Emily Watson" }, { name: "Alex Turner" }],
  },
  {
    id: "4",
...
function getProjectStatus(project: Project): string {
  // Simple logic based on items_count for demo
...
export default function ProjectsPage() {
  ...
  const filteredProjects = mockProjects.filter((project) => {
    ...
    const matchesOwner =
      ownerFilter === "anyone" ||
      (ownerFilter === "me" && project.role === "owner");
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-xl border bg-card overflow-hidden">
                ...
                >
                  ...
                  <td className="py-4 px-4">
                    <span className="text-sm capitalize">
                      {project.role === "owner" ? "Propriétaire" : project.role === "editor" ? "Éditeur" : "Lecteur"}
                    </span>
                  </td>
                  <td className="py-4 px-4">
        ...
        <div className="flex items-center justify-between px-4 py-3 border-t bg-muted/20">
          <p className="text-sm text-muted-foreground">
            Affichage <span className="font-medium">1-{filteredProjects.length}</span> sur{" "}
            <span className="font-medium text-primary">{filteredProjects.length} projets</span>
          </p>
